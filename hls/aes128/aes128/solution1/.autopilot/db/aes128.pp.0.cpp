...
# 15 "src/aes128.cpp" 2
# 1 "D:/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 1 3
# 21 "D:/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 3
extern "C" {
# 45 "D:/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 3
...
# 1 "D:/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\sec_api/string_s.h" 1 3
...
# 1 "D:/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 1 3
# 10 "D:/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\sec_api/string_s.h" 2 3
# 191 "D:/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 2 3
# 16 "src/aes128.cpp" 2
...
#pragma HLS UNROLL
 round_keys[i] = key[i];
    ...
    VITIS_LOOP_38_2: for (int i = 4; i < 44; i++) {
...
#pragma HLS INLINE
 VITIS_LOOP_74_1: for (int i = 0; i < 16; i++) {
#pragma HLS UNROLL
 state[i] ^= round_key[i];
    }
}
...
#pragma HLS INLINE
 VITIS_LOOP_85_1: for (int i = 0; i < 16; i++) {
#pragma HLS UNROLL
...
#pragma HLS INLINE
 VITIS_LOOP_126_1: for (int c = 0; c < 4; c++) {
#pragma HLS UNROLL
 int i = c * 4;
...
#pragma HLS ARRAY_PARTITION variable=state complete
 ...
 VITIS_LOOP_160_1: for (int i = 0; i < 16; i++) {
#pragma HLS UNROLL
 state[i] = plaintext[i];
    }
...
#pragma HLS PIPELINE II=1
 sub_bytes(state);
    ...
    VITIS_LOOP_179_2: for (int i = 0; i < 16; i++) {
#pragma HLS UNROLL
