...
set ID 391
set hasByteEnable 0
set MemName aes128_top_aes128_encrypt_SBOX_ROM_AUTO_1R
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename plaintext_0 \
    op interface \
    ports { plaintext_0_address0 { O 3 vector } plaintext_0_ce0 { O 1 bit } plaintext_0_q0 { I 8 vector } plaintext_0_address1 { O 3 vector } plaintext_0_ce1 { O 1 bit } plaintext_0_q1 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'plaintext_0'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { plaintext_1_address0 { O 3 vector } plaintext_1_ce0 { O 1 bit } plaintext_1_q0 { I 8 vector } plaintext_1_address1 { O 3 vector } plaintext_1_ce1 { O 1 bit } plaintext_1_q1 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename key_0 \
    op interface \
    ports { key_0_address0 { O 3 vector } key_0_ce0 { O 1 bit } key_0_q0 { I 8 vector } key_0_address1 { O 3 vector } key_0_ce1 { O 1 bit } key_0_q1 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename key_1 \
    op interface \
    ports { key_1_address0 { O 3 vector } key_1_ce0 { O 1 bit } key_1_q0 { I 8 vector } key_1_address1 { O 3 vector } key_1_ce1 { O 1 bit } key_1_q1 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename ciphertext_0 \
    op interface \
    ports { ciphertext_0_address0 { O 3 vector } ciphertext_0_ce0 { O 1 bit } ciphertext_0_we0 { O 1 bit } ciphertext_0_d0 { O 8 vector } ciphertext_0_address1 { O 3 vector } ciphertext_0_ce1 { O 1 bit } ciphertext_0_we1 { O 1 bit } ciphertext_0_d1 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'ciphertext_0'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { ciphertext_1_address0 { O 3 vector } ciphertext_1_ce0 { O 1 bit } ciphertext_1_we0 { O 1 bit } ciphertext_1_d0 { O 8 vector } ciphertext_1_address1 { O 3 vector } ciphertext_1_ce1 { O 1 bit } ciphertext_1_we1 { O 1 bit } ciphertext_1_d1 { O 8 vector } } \
} "
} else {
