...
# 2 "<built-in>" 2
# 1 "src/aes128_top.cpp" 2
# 15 "src/aes128_top.cpp"
# 1 "src/aes128.h" 1
# 20 "src/aes128.h"
...
__attribute__((sdx_kernel("aes128_top", 0))) void aes128_top(
    uint32_t *data_in,
    uint32_t *key_in,
    uint32_t *data_out,
    int encrypt
);
# 16 "src/aes128_top.cpp" 2
...
#line 17 "C:/Users/PC-CST-A3/Desktop/edge-ai-soc/hls/aes128/aes128/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=aes128_top
# 22 "src/aes128_top.cpp"
...
#pragma HLS PIPELINE II=1
 uint32_t word = key_in[i];
    ...
    if (encrypt) {
        ...
        VITIS_LOOP_69_1: for (int i = 0; i < 16; i++) {
