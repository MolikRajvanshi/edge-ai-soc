set moduleName aes128_top_Pipeline_LOAD_DATA
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes128_top_Pipeline_LOAD_DATA}
set C_modelType { void 0 }
set C_modelArgList {
	{ DATA int 32 regular {axi_master 0}  }
	{ sext_ln43 int 62 regular  }
	{ plaintext_1 int 8 regular {array 8 { 0 0 } 0 1 }  }
	{ plaintext int 8 regular {array 8 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "DATA", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "data_in","offset": { "type": "dynamic","port_name": "data_in","bundle": "CTRL"},"direction": "READONLY"},{"cName": "key_in","offset": { "type": "dynamic","port_name": "key_in","bundle": "CTRL"},"direction": "READONLY"},{"cName": "data_out","offset": { "type": "dynamic","port_name": "data_out","bundle": "CTRL"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "plaintext_1", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "plaintext", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ plaintext_1_address0 sc_out sc_lv 3 signal 2 } 
	{ plaintext_1_ce0 sc_out sc_logic 1 signal 2 } 
	{ plaintext_1_we0 sc_out sc_logic 1 signal 2 } 
	{ plaintext_1_d0 sc_out sc_lv 8 signal 2 } 
	{ plaintext_1_address1 sc_out sc_lv 3 signal 2 } 
	{ plaintext_1_ce1 sc_out sc_logic 1 signal 2 } 
	{ plaintext_1_we1 sc_out sc_logic 1 signal 2 } 
	{ plaintext_1_d1 sc_out sc_lv 8 signal 2 } 
	{ plaintext_address0 sc_out sc_lv 3 signal 3 } 
	{ plaintext_ce0 sc_out sc_logic 1 signal 3 } 
	{ plaintext_we0 sc_out sc_logic 1 signal 3 } 
	{ plaintext_d0 sc_out sc_lv 8 signal 3 } 
	{ plaintext_address1 sc_out sc_lv 3 signal 3 } 
	{ plaintext_ce1 sc_out sc_logic 1 signal 3 } 
	{ plaintext_we1 sc_out sc_logic 1 signal 3 } 
	{ plaintext_d1 sc_out sc_lv 8 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "plaintext_1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "plaintext_1", "role": "we0" }} , 
 	{ "name": "plaintext_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "plaintext_1", "role": "d0" }} , 
 	...
 	{ "name": "plaintext_1_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "plaintext_1", "role": "we1" }} , 
 	{ "name": "plaintext_1_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "plaintext_1", "role": "d1" }} , 
 	...
 	{ "name": "plaintext_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "plaintext", "role": "we0" }} , 
 	{ "name": "plaintext_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "plaintext", "role": "d0" }} , 
 	...
 	{ "name": "plaintext_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "plaintext", "role": "we1" }} , 
 	{ "name": "plaintext_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "plaintext", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	...
	plaintext_1 { ap_memory {  { plaintext_1_address0 mem_address 1 3 }  { plaintext_1_ce0 mem_ce 1 1 }  { plaintext_1_we0 mem_we 1 1 }  { plaintext_1_d0 mem_din 1 8 }  { plaintext_1_address1 MemPortADDR2 1 3 }  { plaintext_1_ce1 MemPortCE2 1 1 }  { plaintext_1_we1 MemPortWE2 1 1 }  { plaintext_1_d1 MemPortDIN2 1 8 } } }
	plaintext { ap_memory {  { plaintext_address0 mem_address 1 3 }  { plaintext_ce0 mem_ce 1 1 }  { plaintext_we0 mem_we 1 1 }  { plaintext_d0 mem_din 1 8 }  { plaintext_address1 MemPortADDR2 1 3 }  { plaintext_ce1 MemPortCE2 1 1 }  { plaintext_we1 MemPortWE2 1 1 }  { plaintext_d1 MemPortDIN2 1 8 } } }
}
