...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { ciphertext_1_address0 { O 3 vector } ciphertext_1_ce0 { O 1 bit } ciphertext_1_q0 { I 8 vector } ciphertext_1_address1 { O 3 vector } ciphertext_1_ce1 { O 1 bit } ciphertext_1_q1 { I 8 vector } } \
} "
} else {
