set moduleName aes128_top_Pipeline_VITIS_LOOP_69_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes128_top_Pipeline_VITIS_LOOP_69_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ plaintext int 8 regular {array 8 { 1 3 } 1 1 }  }
	{ plaintext_1 int 8 regular {array 8 { 1 3 } 1 1 }  }
	{ ciphertext int 8 regular {array 8 { 0 3 } 0 1 }  }
	{ ciphertext_1 int 8 regular {array 8 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ ciphertext_1_we0 sc_out sc_logic 1 signal 3 } 
	{ ciphertext_1_d0 sc_out sc_lv 8 signal 3 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_8_1_1_U398", "Parent" : "0"},
...
set Spec2ImplPortList { 
	plaintext { ap_memory {  { plaintext_address0 mem_address 1 3 }  { plaintext_ce0 mem_ce 1 1 }  { plaintext_q0 in_data 0 8 } } }
	plaintext_1 { ap_memory {  { plaintext_1_address0 mem_address 1 3 }  { plaintext_1_ce0 mem_ce 1 1 }  { plaintext_1_q0 in_data 0 8 } } }
	ciphertext { ap_memory {  { ciphertext_address0 mem_address 1 3 }  { ciphertext_ce0 mem_ce 1 1 }  { ciphertext_we0 mem_we 1 1 }  { ciphertext_d0 mem_din 1 8 } } }
	ciphertext_1 { ap_memory {  { ciphertext_1_address0 mem_address 1 3 }  { ciphertext_1_ce0 mem_ce 1 1 }  { ciphertext_1_we0 mem_we 1 1 }  { ciphertext_1_d0 mem_din 1 8 } } }
}
