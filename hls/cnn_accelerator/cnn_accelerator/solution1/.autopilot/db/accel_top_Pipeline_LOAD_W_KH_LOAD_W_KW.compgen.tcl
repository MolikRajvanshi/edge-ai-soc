...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 18 \
    name local_weights_V \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename local_weights_V \
    op interface \
    ports { local_weights_V_address1 { O 12 vector } local_weights_V_ce1 { O 1 bit } local_weights_V_we1 { O 1 bit } local_weights_V_d1 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_weights_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sub_ln119 \
    op interface \
    ports { sub_ln119 { I 36 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_weight_data \
    op interface \
    ports { weight_data { I 64 vector } } \
} "
}
