...
set id 20
set name accel_top_mac_muladd_8s_8s_32s_32_4_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_and_ln52_3 \
    op interface \
    ports { and_ln52_3 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_icmp_ln48_1 \
    op interface \
    ports { icmp_ln48_1 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sum_V_1_out { O 32 vector } sum_V_1_out_ap_vld { O 1 bit } } \
} "
}
