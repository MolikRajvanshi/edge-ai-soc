...
set Library     "hls"
set IPName      "accel_top"
set Version     "1.0"
set DisplayName "Accel_top"
set Revision    "2114751507"
...
set xo_kernel_name "accel_top"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/PC-CST-A3/Desktop/edge-ai-soc/hls/cnn_accelerator/cnn_accelerator/solution1"
set debug_dir "C:/Users/PC-CST-A3/Desktop/edge-ai-soc/hls/cnn_accelerator/cnn_accelerator/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {accel_top_mul_31ns_31ns_32_1_1
accel_top_flow_control_loop_pipe_sequential_init
accel_top_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST R 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST R 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 input_data_1 W 0x0 "Data signal of input_data" {{0 32 input_data W 0 "Bit 31 to 0 of input_data"}}} {0x14 input_data_2 W 0x0 "Data signal of input_data" {{0 32 input_data W 0 "Bit 63 to 32 of input_data"}}} {0x1c weight_data_1 W 0x0 "Data signal of weight_data" {{0 32 weight_data W 0 "Bit 31 to 0 of weight_data"}}} {0x20 weight_data_2 W 0x0 "Data signal of weight_data" {{0 32 weight_data W 0 "Bit 63 to 32 of weight_data"}}} {0x28 bias_data_1 W 0x0 "Data signal of bias_data" {{0 32 bias_data W 0 "Bit 31 to 0 of bias_data"}}} {0x2c bias_data_2 W 0x0 "Data signal of bias_data" {{0 32 bias_data W 0 "Bit 63 to 32 of bias_data"}}} {0x34 output_data_1 W 0x0 "Data signal of output_data" {{0 32 output_data W 0 "Bit 31 to 0 of output_data"}}} {0x38 output_data_2 W 0x0 "Data signal of output_data" {{0 32 output_data W 0 "Bit 63 to 32 of output_data"}}} {0x40 kernel_size W 0x0 "Data signal of kernel_size" {{0 32 kernel_size W 0 "Bit 31 to 0 of kernel_size"}}} {0x48 in_channels W 0x0 "Data signal of in_channels" {{0 32 in_channels W 0 "Bit 31 to 0 of in_channels"}}} {0x50 out_channels W 0x0 "Data signal of out_channels" {{0 32 out_channels W 0 "Bit 31 to 0 of out_channels"}}} {0x58 in_height W 0x0 "Data signal of in_height" {{0 32 in_height W 0 "Bit 31 to 0 of in_height"}}} {0x60 in_width W 0x0 "Data signal of in_width" {{0 32 in_width W 0 "Bit 31 to 0 of in_width"}}} {0x68 stride W 0x0 "Data signal of stride" {{0 32 stride W 0 "Bit 31 to 0 of stride"}}} {0x70 padding W 0x0 "Data signal of padding" {{0 32 padding W 0 "Bit 31 to 0 of padding"}}} {0x78 relu_enable W 0x0 "Data signal of relu_enable" {{0 32 relu_enable W 0 "Bit 31 to 0 of relu_enable"}}} {0x80 pool_enable W 0x0 "Data signal of pool_enable" {{0 32 pool_enable W 0 "Bit 31 to 0 of pool_enable"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
source -notrace "D:/Vitis_HLS/2022.1/common/scripts/ipxhls.tcl"
