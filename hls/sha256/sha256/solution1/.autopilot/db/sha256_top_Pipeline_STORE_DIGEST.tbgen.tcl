set moduleName sha256_top_Pipeline_STORE_DIGEST
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sha256_top_Pipeline_STORE_DIGEST}
set C_modelType { void 0 }
set C_modelArgList {
	{ DATA int 32 regular {axi_master 1}  }
	{ sext_ln70 int 62 regular  }
	{ H int 32 regular {array 8 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "DATA", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "message","offset": { "type": "dynamic","port_name": "message","bundle": "CTRL"},"direction": "READONLY"},{"cName": "digest","offset": { "type": "dynamic","port_name": "digest","bundle": "CTRL"},"direction": "WRITEONLY"}]}]} , 
...
set portList { 
	...
	{ sext_ln70 sc_in sc_lv 62 signal 1 } 
...
set Spec2ImplPortList { 
	...
	H { ap_memory {  { H_address0 mem_address 1 3 }  { H_ce0 mem_ce 1 1 }  { H_q0 mem_dout 0 32 } } }
}
