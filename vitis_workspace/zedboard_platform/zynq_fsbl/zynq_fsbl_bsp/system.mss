...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = accel_top
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = accel_top_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = aes128_top
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = aes128_top_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = sha256_top
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = sha256_top_0
END
